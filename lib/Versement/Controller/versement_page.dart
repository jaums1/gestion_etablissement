...
@override
  H_PageShowDialogModifier({int? id}) {
   controller.variable.clear();
    ...
    filtreInscription.H_FiltreElementParID(id:controller.DataVersement.value.IDInscription );
     TShowdialogue.showWidget(
      titre: "Modifier",
      widgets: SizedBox(
        width: 350,
        height: 380,
        child: SingleChildScrollView(
          child: FormVersement(argument: TraitementAction.modifier.name,show: true,
          inscriptionController: filtreInscription.controller,
          ),
        )));
  }
