...
class TVersementController extends GetxController with TControllerData {
  ...
  HLitVersement({String? param = "AFFICHIER"}) {
    if (param == "AFFICHIER") {
      ...
      variable.IDAnneeScolaire.text = DataVersement.IDAnneeScolaire?.toString() ?? '';
      ...
      variable.ResteAPayer.text = DataVersement.ResteAPayer?.toString() ?? '';
      ...
      DataVersement.IDInscription = int.tryParse(variable.IDInscription.text);
      ...
      DataVersement.ResteAPayer = int.tryParse(variable.ResteAPayer.text);
    }
  }
