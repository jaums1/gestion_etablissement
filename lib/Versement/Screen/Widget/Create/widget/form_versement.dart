...
class FormVersement extends StatelessWidget {
  ...
  FormVersement ({super.key, required this.argument, this.show=false});
           ...
           child: Column(
              ...
              Align(
                ...
                child: SizedBox(
                  child: Column(
                    ...
                    children: [
                      TTextCustom.title(text:TFormatters.formatCurrency(controllerInscription.DataInscription.ResteAPayer),
            ...
            controllerInscription.variable.MontantVersement.text.isEmpty ? SizedBox():
               formulaire.formulaireTextCheval(label: "Montant Payer",iconPrefix: Iconsax.money_change,
                ...
                isIconSuffix:true,iconOpen:Iconsax.calendar,onPressedIcon: ()=> TVersementFunction().H_OnChangedDateVersement()
                ...
                iconOpen:Iconsax.calendar,isIconSuffix:true,onPressedIcon: ()=> TVersementFunction().H_OnChangedDateProchainVersement()
                ),),
                    ],
                  ),
                ),
            ...
            Align(
              ...
              child: SizedBox(
               ...
               final keyClasse  =true;
                //  controller.variable.keyClasse.currentState!.validate();
                if (keyClasse) {
               /////// VALIDATION NORMAL
